...
- `formatError` - (optional) Function that receives an [GraphQLError](https://github.com/graphql/graphql-js/blob/271e23e13ec093e7ffb844e7ffaf340ab92f053e/src/error/GraphQLError.js) results as the argument and returns a formatted error.
